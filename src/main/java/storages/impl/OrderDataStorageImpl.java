...
public class OrderDataStorageImpl extends AbstractDataStorageImpl<Order>
    ...
    public OrderDataStorageImpl(DataStorageConfiguration configuration, ShopItemDataStorage shopItemDataStorage, UserDataStorage userDataStorage) {
        super(configuration);
    ...
    private ShopItem getShopItem(Long id) {
        return shopItemDataStorage.getEntities()
                .stream().filter(shopItem -> shopItem.getId().equals(id))
